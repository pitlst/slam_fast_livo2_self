...
namespace hsm
{
    ...
    //         this->pos_end                 = Eigen::Matrix3d::Zero();
    //         this->vel_end                 = Eigen::Matrix3d::Zero();
    //         this->bias_g                  = Eigen::Matrix3d::Zero();
    //         this->bias_a                  = Eigen::Matrix3d::Zero();
    //         this->gravity                 = Eigen::Matrix3d::Zero();
